...
public abstract class Dialogue {
	...
	private static final String[][] TEXT = {GENERAL_TEXT, KEY_TEXT, DOOR_TEXT, SWORD_TEXT, DRAGON_TEXT, PRINCESS_TEXT};
	...
	private static void initWinScreen(){
	...
	private static void initStartMenu(){
		Graphics2D g = (Graphics2D) startMenu.getGraphics();
